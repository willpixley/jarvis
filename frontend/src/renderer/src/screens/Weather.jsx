                    ...
                    >
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <img
                                ...
                                src={
                                    icons[
                                        weatherData.hourly.weather_code[i + weatherData.time_index]
                                    ][
                                        weatherData.hourly.is_day[i + weatherData.time_index]
                                            ? 'day'
                                            : 'night'
                                    ]['image']
                                }
                            ...
                            <p className="text-center text-2xl font-mono font-semibold text-inverse pt-4">
                                {Math.round(
                                    weatherData.hourly.temperature_2m[i + weatherData.time_index]
                                )}
                                &deg;F
                            </p>
                        </div>
